...
/**
 * Artisan Command to export translations beetween formats.
 *
...
class ExportCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'laravel-translation:export {src_driver} {dst_driver}  {--locale=} {--src_location=} {--dst_location=}';
    /**
     * The console command description.
     *
     * @var string
     */
    protected $description = 'Exports translations in different formats.';
    ...
    public function handle(LaravelTranslation $trans)
    {
        ...
        $this->info(__('laravel-translation::commands.export_success', [
            'count' => count($result),
            'to' => $cfg['dst.driver']]
        ));
    }
